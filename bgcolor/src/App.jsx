...
function App() {
  ...
  return (
    <>
      ...
      {/* <h1 className='bg-green-400 text-black rounded-md mb-4'>Tailwind Test</h1>
 ...
 style={{backgroundColor : color}}>
  ...
  <div className="flex flex-wrap justify-center bg-white px-3 gap-3 shadow-lg px-3 py-2 rounded-xl ">
     <button className="outline-none text-white py-1 px-2 rounded-full"
     ...
     style={{backgroundColor : "black"}} onClick={()=> setColor("black")}>
        Black
     </button> <button className="outline-none text-white py-1 px-2 rounded-full"
